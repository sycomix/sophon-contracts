...
import '../SophonFormula.sol';

/*
    SophonFormula test helper that exposes some SophonFormula functions
*/
contract TestSophonFormula is SophonFormula {
    function TestSophonFormula() {
    }
