...
async function initConverter(accounts, activate) {
    ...
    let converter = await SophonConverter.new(tokenAddress, converterExtensionsAddress, 0, connectorTokenAddress, 250000);
...
contract('SophonConverter', (accounts) => {
    ...
    it('verifies the converter data after construction', async () => {
        let converter = await SophonConverter.new(tokenAddress, converterExtensionsAddress, 0, '0x0', 0);
    ...
    it('should throw when attempting to construct a converter with no token', async () => {
        try {
            await SophonConverter.new('0x0', converterExtensionsAddress, 0, '0x0', 0);
    ...
    it('should throw when attempting to construct a converter with no converter extensions', async () => {
        try {
            await SophonConverter.new(tokenAddress, '0x0', 0, '0x0', 0);
            assert(false, "didn't throw");
        }
        catch (error) {
            return utils.ensureException(error);
    ...
    it('should throw when attempting to construct a converter with invalid max fee', async () => {
        try {
            await SophonConverter.new(tokenAddress, converterExtensionsAddress, 1000000000, '0x0', 0);
            assert(false, "didn't throw");
        }
        catch (error) {
            return utils.ensureException(error);
    ...
    it('verifies the first connector when provided at construction time', async () => {
        let converter = await SophonConverter.new(tokenAddress, converterExtensionsAddress, 0, connectorTokenAddress, 200000);
    ...
    it('should throw when attempting to construct a converter with a connector with invalid weight', async () => {
        try {
            await SophonConverter.new(tokenAddress, converterExtensionsAddress, 0, connectorTokenAddress, 1000001);
            assert(false, "didn't throw");
        }
        catch (error) {
            return utils.ensureException(error);
    ...
    it('verifies the owner can update the fee', async () => {
        let converter = await SophonConverter.new(tokenAddress, converterExtensionsAddress, 200000, '0x0', 0);
